...
entry:
  ...
  %"b" = alloca i32
  %"c" = alloca i32
  %".2" = bitcast [24 x i8]* @"strlit_6" to i8*
  %".3" = bitcast [4 x i8]* @"str_fmt" to i8*
  %".4" = call i32 (i8*, ...) @"printf"(i8* %".3", i8* %".2")
  %".5" = bitcast [3 x i8]* @"scanf_fmt" to i8*
  %".6" = call i32 (i8*, ...) @"scanf"(i8* %".5", i32* %"a")
  %".7" = bitcast [23 x i8]* @"strlit_7" to i8*
  %".8" = bitcast [4 x i8]* @"str_fmt" to i8*
  %".9" = call i32 (i8*, ...) @"printf"(i8* %".8", i8* %".7")
  %".10" = bitcast [3 x i8]* @"scanf_fmt" to i8*
  %".11" = call i32 (i8*, ...) @"scanf"(i8* %".10", i32* %"b")
  %".12" = bitcast [24 x i8]* @"strlit_8" to i8*
  %".13" = bitcast [4 x i8]* @"str_fmt" to i8*
...
then_1:
  ...
  %".19" = bitcast [4 x i8]* @"str_fmt" to i8*
...
then_4:
  ...
  %".24" = bitcast [4 x i8]* @"str_fmt" to i8*
...
else_6:
  ...
  %".28" = bitcast [4 x i8]* @"str_fmt" to i8*
...
@"str_fmt" = constant [4 x i8] c"%s\0a\00"
@"strlit_6" = constant [24 x i8] c"digite o primeiro ponto\00"
@"strlit_7" = constant [23 x i8] c"digite o segundo ponto\00"
@"strlit_8" = constant [24 x i8] c"digite o terceiro ponto\00"
